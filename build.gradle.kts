            ...
            pom {
                ...
                withXml {
                    ...
                    val optionalDeps = listOf(
                        Triple("org.springframework.data", "spring-data-commons", libs.versions.spring.data.commons.get()),
                        Triple("org.springframework", "spring-web", libs.versions.spring.web.get()),
                        Triple("org.springframework", "spring-webmvc", libs.versions.spring.webmvc.get()),
                        Triple("org.springframework", "spring-aop", libs.versions.spring.aop.get()),
                        Triple("org.springframework", "spring-context", libs.versions.spring.context.get()),
                        Triple("jakarta.servlet", "jakarta.servlet-api", libs.versions.jakarta.servlet.api.get()),
                        Triple("org.aspectj", "aspectjweaver", "1.9.20.1"),
                        Triple("io.swagger.core.v3", "swagger-annotations", libs.versions.swagger.annotations.get()),
                        Triple("org.slf4j", "slf4j-api", libs.versions.slf4j.api.get())
                    )
